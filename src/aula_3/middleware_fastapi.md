...
- **Rotas GET com *query parameter* e *path parameter*:**
  - *Query Parameter*: O parâmetro é passado na URL, por exemplo: `http://127.0.0.1:8000/api/v1/hello?name=Matheus`.
  - *Path Parameter*: O parâmetro faz parte do caminho da URL, por exemplo: `http://127.0.0.1:8000/api/v1/hello/Matheus`.
...
3. Desenvolva testes de api para validar as requisições. (pode ser qualquer ferramenta de teste de API)
6. Deixe as imagens dentro do repositório no Github.
